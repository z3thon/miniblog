          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-gray-600">
                This page displays blog posts using the API key from <code className="bg-gray-100 px-2 py-1 rounded text-sm">.env.local</code>
              </p>
            </div>
            <Link href="/preview">
          ...
          <>
            <div className="mb-4">
              <p className="text-sm text-gray-500">
                Showing {count} post{count !== 1 ? 's' : ''} from the example API key
              </p>
            </div>
            <BlogList posts={postsWithDecodedTitles} />
          </>
        )}
      </div>
    </main>
